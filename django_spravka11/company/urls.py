...
urlpatterns = patterns('',
    ...
    url(r'^category/top/([\d-]+)/$', views.SeoCompanyList.as_view(), name='top_companylist'),
    ...
    url(r'^(?P<company_pk>\d+)/news/(?P<news_pk>\d+)/$',
        views.CompanyNewsDetail.as_view(),
        name='current_company_news_detail'),
    url(r'^(?P<company_pk>\d+)/service/$', views.CurrentCompanyService.as_view(), name='current_company_service_all'),
    url(r'^(?P<company_pk>\d+)/service/(?P<service_pk>\d+)/$',
        views.CompanyServiceDetail.as_view(),
        name='current_company_service_detail'),
